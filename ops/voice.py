...
ALERT_TEXT = "Atención. Se detectaron señales de voz sintética. Solicita una verificación adicional de identidad antes de continuar. Esta alerta no confirma fraude."
...
def generate_alert(*, client=None):
    state = status()
    ...
    try:
        ...
        with context as transport:
            response = transport.post(
                ...
                json={"text": ALERT_TEXT, "model_id": os.environ.get("ELEVENLABS_MODEL_ID", "eleven_multilingual_v2")},
                timeout=20,
            )
        ...
        return {"status": "ok", "audio": response.content, "content_type": "audio/mpeg", "text": ALERT_TEXT}
